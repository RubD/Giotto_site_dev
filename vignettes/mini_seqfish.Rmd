...
![](../inst/images/mini_datasets/mini_seqfish/vignette_200921/HVGplot.png){ width=50% } 
...
![](../inst/images/mini_datasets/mini_seqfish/vignette_200921/screePlot.png){ width=50% } 

```{r eval=FALSE}
jackstrawPlot(seqfish_mini, ncp = 20)
```

![](../inst/images/mini_datasets/mini_seqfish/vignette_200921/jackstrawPlot.png){ width=50% } 

```{r eval=FALSE}
plotPCA(seqfish_mini)
```

![](../inst/images/mini_datasets/mini_seqfish/vignette_200921/PCA.png){ width=50% } 
...
![](../inst/images/mini_datasets/mini_seqfish/vignette_200921/tSNE.png){ width=50% } 
...
![](../inst/images/mini_datasets/mini_seqfish/vignette_200921/UMAP.png){ width=50% } 
...
![](../inst/images/mini_datasets/mini_seqfish/vignette_200921/showClusterHeatmap.png){ width=50% } 

```{r eval=FALSE}
showClusterDendrogram(seqfish_mini, h = 0.5, rotate = T, cluster_column = 'leiden_clus')
```

![](../inst/images/mini_datasets/mini_seqfish/vignette_200921/showClusterDendrogram.png){ width=50% } 
...
![](../inst/images/mini_datasets/mini_seqfish/vignette_200921/violinPlot.png){ width=50% } 
...
```
![](../inst/images/mini_datasets/mini_seqfish/vignette_200921/plotMetaDataHeatmap.png){ width=50% } 
...
![](../inst/images/mini_datasets/mini_seqfish/vignette_200921/spatDimPlot2D.png){ width=50% } 
...
![](../inst/images/mini_datasets/mini_seqfish/vignette_200921/spatGenePlot2D.png){ width=50% } 
...
![](../inst/images/mini_datasets/mini_seqfish/vignette_200921/heatmSpatialCorGenes.png){ width=50% }
...
![](../inst/images/mini_datasets/mini_seqfish/vignette_200921/spatCellPlot2D.png){ width=50% }
...
![](../inst/images/mini_datasets/mini_seqfish/vignette_200921/cellProximityBarplot.png){ width=50% }
...
![](../inst/images/mini_datasets/mini_seqfish/vignette_200921/cellProximityHeatmap.png){ width=50% }
...
![](../inst/images/mini_datasets/mini_seqfish/vignette_200921/cellProximityNetwork.png){ width=50% }
...
![](../inst/images/mini_datasets/mini_seqfish/vignette_200921/cellProximitySpatPlot2D.png){ width=50% }
...
![](../inst/images/mini_datasets/mini_seqfish/vignette_200921/spatPlot2D.png){ width=50% }
...
![](../inst/images/mini_datasets/mini_seqfish/vignette_200921/plotCellProximityGenes.png){ width=50% }
...
![](../inst/images/mini_datasets/mini_seqfish/vignette_200921/plotICG.png){ width=50% }
...
![](../inst/images/mini_datasets/mini_seqfish/vignette_200921/plotCCcomHeatmap.png){ width=50% }
...
![](../inst/images/mini_datasets/mini_seqfish/vignette_200921/plotCCcomDotplot.png){ width=50% }
...
![](../inst/images/mini_datasets/mini_seqfish/vignette_200921/plotRankSpatvsExpr.png){ width=50% }
...
![](../inst/images/mini_datasets/mini_seqfish/vignette_200921/plotRecovery.png){ width=50% }
